...
import adidasModel1 from '../../assets/adidas/model-1.webp'
import adidasModel2 from '../../assets/adidas/model-2.webp'
import adidasModel3 from '../../assets/adidas/model-3.webp'
...
export const Adidas = () => {
    ...
    return (
        <div>
            ...
            {/*    <NavLink to={PATH.MODEL}><img className={s.img} src={adidasModel1} alt="model-1"/></NavLink>*/}
            {/*    <NavLink to={PATH.MODEL}><img  src={adidasModel2} alt="model-2"/></NavLink>*/}
            {/*    <NavLink to={PATH.MODEL}><img  src={adidasModel3} alt="model-3"/></NavLink>*/}
            {/*</div>*/}
